...
/**
 * @title Footium Football Player Mock Contract V2.
 * @notice An NFT football player.
 */
contract FootiumPlayerMockV2 is
    ERC721Upgradeable,
    ...
    OwnableUpgradeable
{
    ...
    // new added field
    uint256 public numOfBurnedTokens;
    ...
    /**
     * @notice Burns Footium football player with ID `tokenId`.
     * @param tokenId The ID of the player token to be burned.
     * @dev Only contract owner can burn token.
     */
